...
ingredients = ['almond', 'amaretto', 'anchovy', 'anise', 'apple', 'apple juice', 'apricot',
	 ...
	 'beef tenderloin', 'beer', 'beet', 'bell pepper', 'berry', 'biscuit', 'bitter',
	 ...
	 'caper', 'caraway', 'cardamom', 'carrot', 'cashew', 'casserole/gratin',
	 ...
	 'cognac/armagnac', 'collard green', 'connecticut', 'cookie',
	 'coriander', 'corn', 'cornmeal', 'costa mesa', 'cottage cheese', 'couscous',
	 'crab', 'cranberry', 'cranberry sauce', 'cream', 'cream cheese', 'cuba', 'cucumber',
	 'cumin', 'cupcake', 'currant', 'curry', 'custard', 'date', 'dill', 'dip',
	 'dorie greenspan', 'double boiler', 'dried fruit', 'drink', 'duck',
	 ...
	 'garlic', 'gin', 'ginger', 'goat cheese', 'goose', 'gouda', 'gourmet', 'grain',
	 ...
	 'lancaster', 'lasagna', 'leafy green', 'leek', 'legume', 'lemon',
	 ...
	 'mozzarella', 'muffin', 'mushroom', 'mussel', 'mustard', 'mustard green',
	 ...
	 'pickle', 'pie', 'pine nut', 'pineapple', 'pistachio', 'pittsburgh', 'pizza',
	 ...
	 'sugar snap pea', 'sugar', 'sukkot', 'sweet potato/yam', 'swiss cheese', 'swordfish',
	 'tamarind', 'tangerine', 'tapioca', 'tarragon', 'tea', 'tequila', 'thyme',
	 'tilapia', 'tofu', 'tomatillo', 'tomato', 'tortilla', 'tree nut',
	 'tropical fruit', 'trout', 'tuna', 'turnip', 'vanilla', 'veal', 'vegetable',
	 'venison', 'vermouth', 'vinegar', 'vodka', 'waffle', 'walnut', 'wasabi',
	 'watercress', 'watermelon','water', 'wheat', 'whiskey', 'whole wheat',
